...
export const milestones: JourneyMilestone[] = [
  ...
  },
  {
    ...
    body: "Resolved 5,000+ production incidents across AWS and Azure with 99.9% uptime for 50+ Fortune 500 environments. Memory RCA over 2.5 years with the Technical Architect team. Linux, Apache and Tomcat across 200+ servers; logs in Sumo Logic and CloudWatch. Recognized with PTC's Crowdstrike and Digicert Recovery Award for stabilizing customer environments during the CrowdStrike incident and DigiCert certificate expiry.",
