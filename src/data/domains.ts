...
export const domains: Domain[] = [
  { marker: 'DOM / 01', title: 'Site Reliability', desc: 'On-call incident response, RCA, and outage coordination across App, DB, and Network teams — uptime and alert thresholds tracked like SLIs against an availability target.', icon: 'activity' },
